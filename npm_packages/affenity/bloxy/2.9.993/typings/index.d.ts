...
declare module 'bloxy' {
    ...
    export class BloxyClient {
        ...
        public addDeveloperProduct (options: DeveloperProductOptions): Promise<boolean>;
        ...
        public getFollowers (userId: number | RobloxUser | PartialUser): Promise<GetFollowersResponse>;
        public getFollowing (userId: number | RobloxUser | PartialUser): Promise<GetFollowingResponse>;
