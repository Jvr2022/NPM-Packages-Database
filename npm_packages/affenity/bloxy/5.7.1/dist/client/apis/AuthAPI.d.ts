...
export declare type GetAuthTicket = {
    authTicket: string;
};
...
export declare type Logout = unknown;
...
export declare type SendCredentialsVerificationMessage = unknown;
...
export declare type ChangeUserPassword = unknown;
...
export declare type SAMLRequest = unknown;
...
export declare type VerifyTwoStepVerification = unknown;
...
export declare type ChangeUsername = unknown;
