...
export declare type UpdateGroupSettings = unknown;
...
export declare type UpdateGroupIcon = unknown;
export declare type DeclineJoinRequestsOptions = {
    groupId: number;
    userIds: number[];
};
export declare type DeclineJoinRequests = unknown;
...
export declare type AcceptJoinRequests = unknown;
export declare type DeclineJoinRequestOptions = {
    groupId: number;
    userId: number;
};
export declare type DeclineJoinRequest = unknown;
...
export declare type AcceptJoinRequest = unknown;
...
export declare type JoinGroup = unknown;
...
export declare type ChangeOwner = unknown;
export declare type ClaimGroupOptions = {
    groupId: number;
};
export declare type ClaimGroup = unknown;
export declare type KickMemberOptions = {
    groupId: number;
    userId: number;
};
export declare type KickMember = unknown;
export declare type UpdateMemberOptions = {
    groupId: number;
    userId: number;
    roleId: number;
};
export declare type UpdateMember = unknown;
...
export declare type PayoutMembers = unknown;
export declare type UpdateRecurringPayoutsOptions = PayoutMembersOptions;
export declare type UpdateRecurringPayouts = unknown;
...
export declare type DeclineRelationshipRequests = unknown;
...
export declare type UpdateRolePermissions = unknown;
...
export declare type DeleteSocialLink = unknown;
...
export declare type UpdateSocialLink = unknown;
...
export declare type DeleteWallPost = unknown;
export declare type DeleteWallPostsByUserOptions = {
    groupId: number;
    userId: number;
};
export declare type DeleteWallPostsByUser = unknown;
...
export declare type RemovePrimaryGroup = unknown;
export declare type SetPrimaryGroupOptions = {
    groupId: number;
};
export declare type SetPrimaryGroup = unknown;
...
export declare type DeleteRole = unknown;
