...
class GroupShout {
    ...
    constructor(data, self) {
        this._setup = self;
        this.body   = data != null && (data.Body || data.body) != null ? String(data.Body || data.body).toString() : "null";
        this.poster = data != null && data.poster != null ? new classes.User.PartialUser(data.poster, self) : null;
    }
}
