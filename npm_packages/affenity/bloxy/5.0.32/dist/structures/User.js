...
class UserBase {
    ...
    getBadges(options) {
        ...
        return this.client.apis.badgesAPI.getUserBadges(Object.assign(Object.assign({}, options), { userId: this.id }))
            .then(response => new CursorPageClass(this.client, options || {}, response, this.getBadges));
    }
    ...
    getBundles(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.catalogAPI.getUserBundles(Object.assign(Object.assign({}, options), { userId: this.id }))
            .then(response => new CursorPageClass(this.client, options || {}, response, this.getBundles));
    }
    getBundlesByType(bundleType, options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.catalogAPI.getUserBundlesByType(Object.assign(Object.assign({}, options), { userId: this.id, bundleType }))
    ...
    getFollowers(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.friendsAPI.getUserFollowers(Object.assign(Object.assign({}, options), { userId: this.id }))
    ...
    getFollowing(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.friendsAPI.getUserFollowing(Object.assign(Object.assign({}, options), { userId: this.id }))
    ...
    getCollectibles(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.inventoryAPI.getUserCollectibles(Object.assign(Object.assign({}, options), { userId: this.id }))
    ...
    getInventory(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.inventoryAPI.getUserInventory(Object.assign(Object.assign({}, options), { userId: this.id }))
            .then(response => new CursorPageClass(this.client, options, response, this.getInventory));
    }
    getInventoryByAssetTypeId(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.inventoryAPI.getUserInventoryByAssetTypeId(Object.assign(Object.assign({}, options), { userId: this.id }))
    ...
    getFullBodyAvatarImage(options) {
        return this.client.apis.thumbnailsAPI.getUsersFullBodyAvatarImages(Object.assign(Object.assign({}, options), { userIds: [this.id] }))
            .then(response => response.data[0]);
    }
    getAvatarBustImage(options) {
        return this.client.apis.thumbnailsAPI.getUsersAvatarBustImages(Object.assign(Object.assign({}, options), { userIds: [this.id] }))
            .then(response => response.data[0]);
    }
    getAvatarHeadShotImage(options) {
        return this.client.apis.thumbnailsAPI.getUsersAvatarHeadShotImages(Object.assign(Object.assign({}, options), { userIds: [this.id] }))
            .then(response => response.data[0]);
    }
    getCanTrade() {
