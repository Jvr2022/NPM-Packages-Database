...
export declare type ValidateDisplayNameNewUser = unknown;
export declare type ValidateDisplayNameExistingUserOptions = {
    userId: number;
    displayName: string;
};
export declare type ValidateDisplayNameExistingUser = unknown;
export declare type SetSelfDisplayNameOptions = {
    userId: number;
    newDisplayName: string;
};
export declare type SetSelfDisplayName = unknown;
