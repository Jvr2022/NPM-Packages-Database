...
export declare type CheckSessionHealth = unknown;
export declare type RedeemNearbyFriendCodeOptions = {
    code: string;
};
export declare type RedeemNearbyFriendCode = unknown;
export declare type DeleteSession = unknown;
...
export declare type DeleteQRCodeSession = unknown;
...
export declare type DeclineAllFriendRequests = unknown;
export declare type AcceptFriendRequestOptions = {
    userId: number;
};
export declare type AcceptFriendRequest = unknown;
export declare type DeclineFriendRequestOptions = AcceptFriendRequestOptions;
export declare type DeclineFriendRequest = unknown;
...
export declare type UnfriendUser = unknown;
