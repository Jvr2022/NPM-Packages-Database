...
export declare type UpdatePlugin = unknown;
...
export declare type SearchUniverseData = {
    id: number;
    name: string;
    description: string;
    isArchived: boolean;
...
export declare type ActivateUniverse = unknown;
export declare type DeactivateUniverseOptions = {
    universeId: number;
};
export declare type DeactivateUniverse = unknown;
export declare type GenerateUniverseStatisticReportsByTimeOptions = {
    universeId: number;
    yearDashMonth: string;
};
export declare type GenerateUniverseStatisticReportsByTime = unknown;
...
export declare type UpdateUniverseTeamCreateSettings = unknown;
export declare type RemoveUserFromUniverseTeamCreateOptions = {
    universeId: number;
    userId: number;
};
export declare type RemoveUserFromUniverseTeamCreate = unknown;
...
export declare type CreateUniverseAlias = unknown;
export declare type DeleteUniverseAliasOptions = {
    universeId: number;
    name: string;
};
export declare type DeleteUniverseAlias = unknown;
export declare type UpdateUniverseAliasOptions = CreateUniverseAliasOptions;
export declare type UpdateUniverseAlias = unknown;
...
export declare type UpdateDeveloperProduct = unknown;
