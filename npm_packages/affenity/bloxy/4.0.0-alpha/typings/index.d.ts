...
declare module "bloxy" {
    export class Client extends ClientBase {
        ...
        public on(event: "chatTyping", listener: ({isTyping: boolean, userId: number, conversationId: number}) => void): this;
        public on(event: "chatMessage", listener: (conversationId: number) => void): this;
        public on(event: "chatMessageSent", listener: (conversationId: number) => void): this;
        public on(event: "chatMemberAdded", listener: (conversationId: number) => void): this;
        public on(event: "chatMemberLeft", listener: (conversationId: number) => void): this;
        public on(event: "chatConversation", listener: (conversationId: number) => void): this;
        public on(event: "chatConversationRemoved", listener: (conversationId: number) => void): this;
        public on(event: "friendLost", listener: (userId: number) => void): this;
        public on(event: "friendRequest", listener: (userId: number) => void): this;
        public on(event: "friendAdded", listener: (userId: number) => void): this;
    ...
    class GroupMember extends UserBase {
        constructor(env: Env, data: object);
        ...
        public setRole(role?: GroupRoleIdentifier): Promise<true>;
    ...
    class ChatManager {
        ...
        private getConversationMessages(options: ChatOptions): Promise<Array<ChatMessage>>;

        private getUnreadConversationMessages(conversations: Array<ChatConversationIdentifier>, pageSize?: number): Promise<Array<ChatMessage>>;

        private addToConversation(userIds: Array<UserIdentifier>, conversation: ChatConversationIdentifier): Promise<true>;

        private markMessageRead(conversation: ChatConversationIdentifier, messageId: ChatMessageIdentifier): Promise<true>;

        private markConversationsRead(conversations: Array<ChatConversationIdentifier>): Promise<true>;

        private removeFromConversation(userId: UserIdentifier, conversation: ChatConversationIdentifier): Promise<true>;

        private renameGroupConversation(conversation: ChatConversationIdentifier, title: string): Promise<true>;

        private sendMessage(message: string, conversation: ChatConversationIdentifier): Promise<SentChatMessage>;

        private updateTypingStatus(conversation: ChatConversationIdentifier, isTyping: boolean): Promise<true>;

        public getSettings(): Promise<ChatSettings>;

        public getConversationsById(conversations: Array<AnyIdentifier>): Promise<Array<ChatConversationIdentifier>>;

        public getUnreadConversationsCount(): Promise<number>;

        public getConversations(page?: number, pageSize?: number): Promise<Array<ChatConversationIdentifier>>;

        public getMetadata(): Promise<ChatMetadata>;

        public createGroupConversation(users: Array<UserIdentifier>, title: string): Promise<ChatConversationIdentifier>;
    ...
    class ChatConversation {
        ...
        public setTyping(isTyping: boolean): Promise<true>;
    }
