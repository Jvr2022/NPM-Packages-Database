...
export declare type UnpackBundle = unknown;
...
export declare type RemoveSelfAssetFavorite = unknown;
...
export declare type FavoriteAsset = unknown;
export declare type RemoveFavoriteBundleOptions = {
    userId: number;
    bundleId: number;
};
export declare type RemoveFavoriteBundle = unknown;
...
export declare type FavoriteBundle = unknown;
