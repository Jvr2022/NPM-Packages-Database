...
const getRequester_1 = tslib_1.__importDefault(require("./lib/getRequester"));
...
class RESTController {
    constructor(client, options) {
         ...
         */
        this.requester = getRequester_1.default(this, this.options.requester || undefined);
    }
    /**
     * Sends a request
    ...
    getXCSRFToken() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!this.options.xcsrf || (Date.now() - (this.options.xcsrfSet || 0)) >= (this.options.xcsrfRefreshInterval || RESTInterfaces_1.DefaultRESTControllerOptions.xcsrfRefreshInterval)) {
                // Refresh token
                yield this.fetchXCSRFToken()
                    .then(token => {
     ...
     */
    setOptions(options) {
        this.options = utilFunctions_1.utilMergeDeep(RESTInterfaces_1.DefaultRESTControllerOptions, options || {});
        return this.options;
    }
}
