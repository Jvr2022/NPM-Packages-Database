...
class GroupBase {
    ...
    getUniverses(options) {
        return this.client.apis.developAPI.getGroupUniverses(Object.assign(Object.assign({}, options), { groupId: this.id })).then(response => {
            ...
            return new Asset_1.CursorPage(this.client, options || {}, Object.assign(Object.assign({}, response), { data: response.data.map(universeData => new Game_1.PartialGameUniverse(({
                    id: universeData.id,
    ...
    getJoinRequests(options) {
        return this.client.apis.groupsAPI.getJoinRequests(Object.assign({ groupId: this.id }, options)).then(response => new Asset_1.CursorPage(this.client, options, response, this.getJoinRequests));
    }
    ...
    getMembersWithRole(options) {
        return this.client.apis.groupsAPI.getMembersWithRole(Object.assign({ groupId: this.id }, options)).then(response => new Asset_1.CursorPage(this.client, options, response, this.getMembersWithRole));
    }
    getMembers(options) {
        return this.client.apis.groupsAPI.getMembers(Object.assign({ groupId: this.id }, options)).then(response => new Asset_1.CursorPage(this.client, options, response, this.getMembers));
    }
    join(options) {
    ...
    getWallPosts(options) {
        return this.client.apis.groupsAPI.getWallPosts(Object.assign({ groupId: this.id }, options)).then(response => new Asset_1.CursorPage(this.client, options, response, this.getWallPosts));
    }
...
class GroupJoinRequest {
    constructor(data, client) {
        ...
        this.user = new User_1.PartialUser(data.user, client);
        this.group = new PartialGroup(data.group, client);
...
class GroupShout {
    constructor(data, client) {
        ...
        this.creator = new User_1.PartialUser(data.creator, client);
        this.group = new PartialGroup({
            id: data.group.id,
            name: data.group.name
        }, client);
