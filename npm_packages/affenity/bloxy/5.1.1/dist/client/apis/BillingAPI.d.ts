...
export declare type SubmitDeveloperExchange = unknown;
...
export declare type SubmitLuobuDeveloperExchange = unknown;
...
export declare type PurchaseAmazonProduct = unknown;
export declare type ValidateAmazonProductOptions = {
    productId: string;
    currency: string;
};
export declare type ValidateAmazonProduct = unknown;
...
export declare type RedeemDigitalCode = unknown;
...
export declare type ReverseGameCard = unknown;
...
export declare type PurchaseGoogleProduct = unknown;
