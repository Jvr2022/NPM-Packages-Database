...
class Client extends ClientBase_1.default {
    ...
    getGroup(groupId) {
        return this.apis.groupsAPI.getGroup({
            ...
            if (!data) {
                ...
                return new Group_1.Group(data, this);
            }
        });
    }
    getUser(userId) {
    ...
    getUserIdFromUsername(username) {
        return this.apis.generalApi.getUserByUsername({
            username
        }).then(data => new User_1.PartialUser(data, this));
    }
    ...
    getUsersByUserIds(userIds, excludeBannedUsers = false) {
        return this.apis.usersAPI.getUsersByIds({
            excludeBannedUsers,
            userIds
        }).then(response => response.data.map(userData => new User_1.PartialUser(userData, this)));
    }
