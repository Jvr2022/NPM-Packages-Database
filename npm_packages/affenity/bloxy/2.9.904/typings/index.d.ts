...
export class BloxyClient {
    ...
    public getMessages (options: MessagesOptions): Promise<GetMessagesResponse>;
...
class GroupFunctions {
    ...
    public getAuditLogs (options?: AuditLogOptions): Promise<Array<AuditLog>>;
    ...
    public getWall (options?: GetUsersOptions): Promise<GetWallResponse>;
