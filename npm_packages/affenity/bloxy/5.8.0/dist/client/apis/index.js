...
const TwoStepVerificationAPI_1 = tslib_1.__importDefault(require("./TwoStepVerificationAPI"));
...
function initAPIs(client) {
    return {
        ...
        dataAPI: new DataAPI_1.default(client),
        ...
        twpStepVerification: new TwoStepVerificationAPI_1.default(client)
    };
}
