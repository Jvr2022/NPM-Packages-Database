...
class GameUniverse {
    constructor(data, client) {
        ...
        this.creator = this.creatorType === constants_1.CreatorType.GROUP ? new Group_1.PartialGroup({
            id: data.creator.id,
            name: data.creator.name
        }, client) : new User_1.PartialUser({
            id: data.creator.id,
            name: data.creator.name
        }, client);
        this.price = data.price;
...
class VIPServer {
    constructor(data, client) {
        ...
        this.permissions = {
            ...
            users: data.permissions.users.map(userData => new User_1.PartialUser(userData, client))
        };
    }
}
