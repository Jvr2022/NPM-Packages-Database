...
class UserBase {
    ...
    getBadges(options) {
        return this.client.apis.badgesAPI.getUserBadges(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options || {}, response, this.getBadges));
    }
    ...
    getBundles(options) {
        return this.client.apis.catalogAPI.getUserBundles(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options || {}, response, this.getBundles));
    }
    getBundlesByType(bundleType, options) {
        return this.client.apis.catalogAPI.getUserBundlesByType(Object.assign(Object.assign({}, options), { userId: this.id, bundleType })).then(response => new Asset_1.CursorPage(this.client, options || {}, response, this.getBundlesByType));
    }
    ...
    getFollowers(options) {
        return this.client.apis.friendsAPI.getUserFollowers(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options || {}, response, this.getFollowers));
    }
    getFollowersCount() {
    ...
    getFollowing(options) {
        return this.client.apis.friendsAPI.getUserFollowing(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options || {}, response, this.getFollowing));
    }
    getFollowingCount() {
    ...
    getCollectibles(options) {
        return this.client.apis.inventoryAPI.getUserCollectibles(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options || {}, response, this.getCollectibles));
    }
    getItemsByTypeAndTargetId(itemType, id) {
        return this.client.apis.inventoryAPI.getUserItemsByTypeAndTargetId({
            ...
            itemTargetId: id,
            userId: this.id
        }).then(response => new Asset_1.CursorPage(this.client, {}, response, this.getItemsByTypeAndTargetId));
    }
    getInventory(options) {
        return this.client.apis.inventoryAPI.getUserInventory(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options, response, this.getInventory));
    }
    getInventoryByAssetTypeId(options) {
        return this.client.apis.inventoryAPI.getUserInventoryByAssetTypeId(Object.assign(Object.assign({}, options), { userId: this.id })).then(response => new Asset_1.CursorPage(this.client, options, response, this.getInventoryByAssetTypeId));
    }
