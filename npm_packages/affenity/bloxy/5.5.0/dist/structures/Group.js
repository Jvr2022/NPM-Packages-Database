...
class GroupBase {
    ...
    getUniverses(options) {
        return this.client.apis.developAPI.getGroupUniverses(Object.assign(Object.assign({}, options), { groupId: this.id }))
            .then(response => {
    ...
    getJoinRequests(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI.getJoinRequests(Object.assign({ groupId: this.id }, options))
            .then(response => new CursorPageClass(this.client, options, response, this.getJoinRequests));
    }
    ...
    getMembersWithRole(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI.getMembersWithRole(Object.assign({ groupId: this.id }, options))
            .then(response => new CursorPageClass(this.client, options, response, this.getMembersWithRole));
    }
    getMembers(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI.getMembers(Object.assign({ groupId: this.id }, options))
            .then(response => new CursorPageClass(this.client, options, response, this.getMembers));
    }
    join(options) {
    ...
    getWallPosts(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI.getWallPosts(Object.assign({ groupId: this.id }, options))
            .then(response => new CursorPageClass(this.client, options, response, this.getWallPosts));
    }
