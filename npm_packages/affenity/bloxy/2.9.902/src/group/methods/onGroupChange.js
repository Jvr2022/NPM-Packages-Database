...
class GroupChangeEvent extends EventEmitter {
    ...
    init () {
        ClientMethods.getGroup(this._group.groupId, this._self, true).then(groupInfo => {
            ...
            this.interval = setInterval( () => {
                ClientMethods.getGroup(this._group.groupId, this._self, true).then(groupInfo => {
                    ...
                    if ( !thisShout || !thisShout.body || thisShout && thisShout.body && thisShout.body.toLowerCase() != cachedShout.body.toLowerCase()) this.emit('shout', {
