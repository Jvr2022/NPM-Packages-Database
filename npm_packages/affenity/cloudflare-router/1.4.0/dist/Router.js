...
class Router {
    ...
    serve(request, additionalData, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            request = (!(request instanceof RouterRequest_1.RouterRequest) ? new RouterRequest_1.RouterRequest(request, additionalData) : request);
            response = response || new RouterResponse_1.RouterResponse(request);
    ...
    createRoute(options) {
        ...
        return new Route(this, Object.assign({}, options));
    }
    createRouteAndAddInternally(options) {
