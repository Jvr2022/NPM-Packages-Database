...
export declare class Router<AdditionalDataType extends unknown> {
    basePath: string;
    isWaterfall: boolean;
    ...
    createRouteAndAddInternally(options: RouteOptions<AdditionalDataType>): Route<AdditionalDataType>;
